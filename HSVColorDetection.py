...
while(1): 
    ...
    # Creating contour to track green color 
        ...
        black = [False]
    if (found == lookfor):
        print("Lock On! Stop moving") #networktable to robot to stop and reposition
        coloredboxesfound = [True]
#         sd.putBoolean('Found', True)
#         sd.putNumber('BoxCoordinate', BoxCoordinateX)
#                 if (boxCoordinateX == 0)
#                     boxiscentered = True
#                     if (boxiscentered == True)
#                         sd.getNumber('inposition', inposition)
#                         if (inposition == 'True')
#                             #findbox
#                             if (lookfordepositfox == lookfor)
#                                 correctboxfound = [True]
#                                 if (correctboxfound == True)
#                                     deposit = 'True'
#                                     sd.putNumber('CanDeposit', deposit)
#                                 
#                     
#                 sd.getBoolean('Robotiscentered', RobotCentered)
#                 if (RobotCentered == True)
    ...
    # Program Termination 
    cv2.imshow("HSVColorDetection", imageFrame) 
